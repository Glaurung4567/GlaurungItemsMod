...
{
	internal class SwissArmyRifle : AdvancedGunBehavior
	{
		public static void Add()
		{
			...
			gun.gameObject.AddComponent<SwissArmyRifle>();
			GunExt.SetShortDescription(gun, "Shoot Style: Yes");
			GunExt.SetLongDescription(gun, "A gun packed with different firing modes usable all at once to be able to handle any situation.");
