...
{
	public class CustomChamberGunFormeSynergyProcessor : MonoBehaviour
	{
		private void Awake()
		{
			...
			form0.RequiredSynergy = "Parry the Secrets of Otters Chamber";
			form0.FormeID = 647;

			CustomGunFormeData form1 = new CustomGunFormeData();
			form1.RequiresSynergy = true;
			form1.RequiredSynergy = "Parry the Secrets of Otters Chamber";
			form1.FormeID = 657;

			CustomGunFormeData form2 = new CustomGunFormeData();
			form2.RequiresSynergy = true;
			form2.RequiredSynergy = "Parry the Secrets of Otters Chamber";
			form2.FormeID = 763;

			this.Formes = new CustomGunFormeData[] { form0, form1, form2 };
		...
		public static IEnumerator HandleTransformationDuration(PlayerController targetPlayer, int gunID, float duration)
		{
			...
			CustomChamberGunFormeSynergyProcessor.ClearTemporaryOverrideGun(targetPlayer, m_extantGun);
			yield break;
		}
