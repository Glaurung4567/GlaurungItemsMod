...
namespace ItemAPI
{
    public static class ItemBuilder
    {
        ...
        /// ammonomicon for later use. If obj is null, returns a new GameObject with the sprite
        /// </summary>
        public static GameObject AddSpriteToObject2(string name, string resourcePath, GameObject obj = null, bool copyFromExisting = true)
        {
            GameObject gameObject = SpriteBuilder.SpriteFromResource2(resourcePath, obj, copyFromExisting);
        ...
        public static GameObject AddSpriteToObject3(string name, string resourcePath, GameObject obj = null, bool copyFromExisting = true)
        {
            GameObject gameObject = SpriteBuilder.SpriteFromResource3(resourcePath, obj, copyFromExisting);
            FakePrefab.MarkAsFakePrefab(gameObject);
            obj.SetActive(false);
            gameObject.name = name;
            return gameObject;
        ...
        public static void SetupItem3(PickupObject item, string shortDesc, string longDesc, string idPool = "customItems")
        {
            try
            {
                item.encounterTrackable = null;
                ETGMod.Databases.Items.SetupItem(item, item.name);
                SpriteBuilder.AddToAmmonomicon3(item.sprite.GetCurrentSpriteDef());
                item.encounterTrackable.journalData.AmmonomiconSprite = item.sprite.GetCurrentSpriteDef().name;
        ...
        // from spapi discord
        public static void AddPassiveStatModifierForGuns(this Gun gun, PlayerStats.StatType statType, float amount, StatModifier.ModifyMethod modifyMethod)
        {
