...
namespace ItemAPI
{
    public static class SpriteBuilder
    {
        ...
        public static GameObject SpriteFromResource2(string spriteName, GameObject obj = null, bool copyFromExisting = true)
        {
            ...
            {
                result = SpriteBuilder.SpriteFromTexture2(textureFromResource, text, obj, copyFromExisting);
            }
            return result;
        }
        ...
        /// Returns an object with a tk2dSprite component with the texture provided
        /// </summary>
		public static GameObject SpriteFromTexture2(Texture2D texture, string spriteName, GameObject obj = null, bool copyFromExisting = true)
        {
            bool flag = obj == null;
            bool flag2 = flag;
            if (flag2)
            ...
            if (copyFromExisting)
            {
                tk2dSprite = SpriteBuilder.AddComponent(obj, SpriteBuilder.baseSprite);
            }
            else
            {
                tk2dSprite = obj.AddComponent<tk2dSprite>();
            }
            int num = SpriteBuilder.AddSpriteToCollection(spriteName, SpriteBuilder.itemCollection);
            tk2dSprite.SetSprite(SpriteBuilder.itemCollection, num);
        ...
        // from [Retrash's] Custom Items Collection - Blunderbeast 
        // Token: 0x06000024 RID: 36 RVA: 0x00002CF8 File Offset: 0x00000EF8
        public static GameObject SpriteFromResource3(string spriteName, GameObject obj = null, bool copyFromExisting = true)
        {
            string str = (!spriteName.EndsWith(".png")) ? ".png" : "";
            string text = spriteName + str;
            Texture2D textureFromResource = ResourceExtractor.GetTextureFromResource(text);
            ...
            {
                result = SpriteBuilder.SpriteFromTexture3(textureFromResource, text, obj, copyFromExisting);
            }
            return result;
        }
        ...
        public static GameObject SpriteFromTexture3(Texture2D texture, string spriteName, GameObject obj = null, bool copyFromExisting = true)
        {
            bool flag = obj == null;
            bool flag2 = flag;
            if (flag2)
            ...
            int num = SpriteBuilder.AddSpriteToCollection3(spriteName, SpriteBuilder.itemCollection);
            tk2dSprite.SetSprite(SpriteBuilder.itemCollection, num);
            tk2dSprite.SortingOrder = 0;
            obj.GetComponent<BraveBehaviour>().sprite = tk2dSprite;
            return obj;
        ...
        // from [Retrash's] Custom Items Collection - Blunderbeast 
        // Token: 0x06000026 RID: 38 RVA: 0x00002DD8 File Offset: 0x00000FD8
        public static int AddSpriteToCollection3(string resourcePath, tk2dSpriteCollectionData collection)
        {
            ...
            return SpriteBuilder.AddSpriteToCollection3(tk2dSpriteDefinition, collection);
        }

        // from [Retrash's] Custom Items Collection - Blunderbeast 
        // Token: 0x06000027 RID: 39 RVA: 0x00002E30 File Offset: 0x00001030
        public static int AddSpriteToCollection3(tk2dSpriteDefinition spriteDefinition, tk2dSpriteCollectionData collection)
        {
        ...
        // from [Retrash's] Custom Items Collection - Blunderbeast 
        // Token: 0x06000028 RID: 40 RVA: 0x00002E94 File Offset: 0x00001094
        public static int AddToAmmonomicon3(tk2dSpriteDefinition spriteDefinition)
        {
            return SpriteBuilder.AddSpriteToCollection3(spriteDefinition, SpriteBuilder.ammonomiconCollection);
        }
        ...
        {
            return SpriteBuilder.CopyFrom(go.AddComponent<T>(), toAdd) as T;
        }
    }
}
